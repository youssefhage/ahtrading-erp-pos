...
function SalesInvoiceShowInner() {
  ...
  const invoiceLineColumns = useMemo((): Array<DataTableColumn<InvoiceLine>> => {
    ...
    return [
      ...
      { id: "unit_price_lbp", header: "Unit LBP", sortable: true, align: "right" as const, mono: true, defaultHidden: true, accessor: (l) => Number((l as any).unit_price_lbp || 0), cell: (l) => <span className="data-mono text-xs">{fmtLbp((l as any).unit_price_lbp)}</span> },
      ...
      { id: "discount_amount_lbp", header: "Discount LBP", sortable: true, align: "right" as const, mono: true, defaultHidden: true, accessor: (l) => Number((l as any).discount_amount_lbp || 0), cell: (l) => <span className="data-mono text-xs">{fmtLbp((l as any).discount_amount_lbp)}</span> },
      ...
      { id: "tax_lbp_calc", header: "Tax LBP", sortable: true, align: "right" as const, mono: true, defaultHidden: true, accessor: (l) => lineTax(l).tax_lbp, cell: (l) => <span className="data-mono text-xs">{fmtLbp(lineTax(l).tax_lbp)}</span> },
      ...
      { id: "line_total_lbp", header: "Total LBP", sortable: true, align: "right" as const, mono: true, accessor: (l) => Number(l.line_total_lbp || 0), cell: (l) => <span className="data-mono text-xs">{fmtLbp(l.line_total_lbp)}</span> },
    ];
