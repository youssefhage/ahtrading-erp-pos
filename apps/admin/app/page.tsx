        ...
        <div className="mx-auto max-w-5xl">
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-8">
            ...
            <div className="flex flex-col justify-center space-y-6">
              <div className="inline-flex w-fit items-center gap-2 rounded-full border border-amber-500/20 bg-amber-500/10 px-3 py-1">
                <span className="relative flex h-2 w-2">
                  <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-amber-400 opacity-75"></span>
                  <span className="relative inline-flex h-2 w-2 rounded-full bg-amber-500"></span>
                </span>
                <span className="text-xs font-medium text-amber-400">v2.0 Terminal Edition</span>
              </div>
...
function FeatureCard({
  ...
  return (
    <div className="rounded-lg border border-border-subtle bg-bg-elevated/70 p-4 transition-all duration-200 hover:border-border-strong hover:bg-bg-sunken/60">
      <div className="mb-3 flex h-10 w-10 items-center justify-center rounded-md bg-bg-sunken text-amber-600 dark:text-amber-400">
