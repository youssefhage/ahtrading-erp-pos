  ...
  return (
    <div className="mx-auto max-w-5xl space-y-6">
      <PageHeader
        ...
        backHref={`/accounting/journal-templates/${encodeURIComponent(id)}`}
      >
          ...
          <CardHeader>
            <div className="flex flex-wrap items-center justify-between gap-2">
              <div>
                ...
                <p className="mt-1 text-sm text-muted-foreground">Template must balance.</p>
              </div>
            ...
            {lines.map((l, idx) => (
              ...
              >
                ...
                <div className="space-y-1">
                  ...
                  <Input className="h-9" value={l.memo} onChange={(e) => updateLine(idx, { memo: e.target.value })} />
                </div>
                <div className="space-y-1">
      ...
      <div className="sticky bottom-0 z-10 -mx-6 border-t bg-background/95 px-6 py-3 backdrop-blur supports-[backdrop-filter]:bg-background/80">
        <div className="mx-auto flex max-w-5xl items-center justify-end gap-3">
          <Button
            type="button"
            variant="outline"
            onClick={() => router.push(`/accounting/journal-templates/${encodeURIComponent(id)}`)}
          >
