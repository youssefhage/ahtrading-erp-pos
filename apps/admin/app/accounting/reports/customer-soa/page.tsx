    ...
    <div className="mx-auto max-w-7xl space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Invoices, payments, returns, and refunds for a single customer.</CardDescription>
        </CardHeader>
          ...
          <CardHeader>
            ...
            <CardDescription>
              ...
              {data.customer?.code ? (
                <>
                  {" "}
                  · <span className="font-mono text-xs">{data.customer.code}</span>
                </>
              ) : null}
            </CardDescription>
          </CardHeader>
      ...
      <Card>
        ...
        <CardContent>
          <DataTable
            tableId="reports.customer-soa.v1"
            rows={data?.rows || []}
            columns={columns}
            getRowId={(r, idx) => `${r.doc_id}:${idx}`}
            emptyText={customer?.id ? "No transactions in range." : "Select a customer to view the statement."}
