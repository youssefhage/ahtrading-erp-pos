...
run_migration "054_item_categories" "backend/db/migrations/054_item_categories.sql"
run_migration "055_item_masterdata_v2" "backend/db/migrations/055_item_masterdata_v2.sql"
run_migration "056_party_contacts_and_active" "backend/db/migrations/056_party_contacts_and_active.sql"
...
run_migration "061_admin_list_indexes" "backend/db/migrations/061_admin_list_indexes.sql"
