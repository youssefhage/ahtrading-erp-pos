        ...
        with conn.transaction():
            with conn.cursor() as cur:
                ...
                for r in rules:
                    ...
                    # Each rule runs in its own savepoint so one failure doesn't roll back all.
                    try:
                        with conn.transaction():
                            ...
                            cur.execute(
                                ...
                                VALUES
                                  (gen_random_uuid(), %s, %s, 'recurring_journal', %s, %s, %s, %s, %s, NULL)
                                RETURNING id
                                """,
                        ...
                        # Savepoint rolled back; log failure and push next_run_date forward.
                        cur.execute(
                            """
                            INSERT INTO audit_logs (id, company_id, user_id, action, entity_type, entity_id, details)
